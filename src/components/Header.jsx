                ...
                <div className="-mx-4 leading-[89px] flex items-center justify-between justify-content-center">
                    <div className="md:w-1/3 w-1/4 xl:hidden">
                        <a href="#mobileMenu" className="mobile-menu" data-bs-toggle="offcanvas" aria-controls="mobileMenu">
                            <i className="text-xs font-semibold icon-categories"></i>
                        </a>
                    </div>
                    <div className="w-1/2  md:w-1/3 xl:w-1/4">
                        <Link to="/" className="block w-[144px]">
                            <img src={logo} alt="logo" className="h-10 w-auto object-contain"/>
                        </Link>
                    </div>
                    <div className="xl:w-1/2 hidden xl:block">
                        <nav className="box-navigation text-center">
                            <ul className="flex items-center justify-content-center gap-4">
                                <li className="px-4 active">
                                    <Link to="/" className="text-base leading-[26px] font-semibold flex items-center gap-1 transition-all duration-300 ease-in-out relative">Home</Link>  
                                </li>
                                <li className="px-4">
                                    <Link to="/products" className="text-base leading-[26px] font-semibold flex items-center gap-1 transition-all duration-300 ease-in-out relative">Product Page</Link>  
                                </li>
                                <li className="px-4 relative group">
                                    <a href="#" className="text-base leading-[26px] font-semibold flex items-center gap-1 transition-all duration-300 ease-in-out relative">Shop<i className="text-xs font-semibold icon-arrow-down"></i></a>
                                    
                                </li>
                                <li className="px-4">
                                    <a href="#" className="text-base leading-[26px] font-semibold flex items-center gap-1 transition-all duration-300 ease-in-out relative">Products<i className="text-xs font-semibold icon-arrow-down"></i></a>
                                </li>
                                <li className="px-4">
                                    <a href="#" className="text-base leading-[26px] font-semibold flex items-center gap-1 transition-all duration-300 ease-in-out relative">Blog<i className="text-xs font-semibold icon-arrow-down"></i></a>
                                    
                                </li>
                                <li className="px-4">
                                    <a href="#" className="text-base leading-[26px] font-semibold flex items-center gap-1 transition-all duration-300 ease-in-out relative">Pages<i className="text-xs font-semibold icon-arrow-down"></i></a>
                    ...
                    <div className="xl:w-1/4 md:w-1/3 w-1/4 ">
                        <ul className="flex justify-end  gap-5">
                            <li className="nav-search"><a href="#search" data-bs-toggle="modal" className="inline-flex">
                                <svg className="text-xs font-semibold" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="nav-wishlist"><a href="wish-list.html" className="inline-flex">
                                <svg className="text-xs font-semibold" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="nav-cart"><a href="#shoppingCart" data-bs-toggle="modal" className="inline-flex">
                                <svg className="text-xs font-semibold" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
